...
class App extends Component {
    ...
    componentDidMount = async () => {
        try {
            ...
            // let {subs, subInfo, stagingArea, subBox} = this.state;
            ...
            //
            // await gapiYT.initStagingArea(subs, stagingArea);
            //
            // await gapiYT.populateSubBox(subBox, stagingArea);
            //
            // console.log(subs);
            // console.log(subInfo);
